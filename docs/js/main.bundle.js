...
const formError = () => {
  ...
  document.addEventListener('keydown', (evt) => {
    if ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.isEscEvent)(evt)) {
      evt.preventDefault();
      newError.classList.add('hidden');
      document.removeEventListener('keydown', _util_js__WEBPACK_IMPORTED_MODULE_0__.isEscEvent);
    }
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   openEditingForm: () => (/* binding */ openEditingForm)
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./source/js/util.js");
/* harmony import */ var _validation_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./validation.js */ "./source/js/validation.js");
/* harmony import */ var _alert_messages_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alert-messages.js */ "./source/js/alert-messages.js");
...
const onFormClose = () => {
  ...
  uploadButton.value = '';
  editingImage.style = '';
  (0,_validation_js__WEBPACK_IMPORTED_MODULE_1__.clearTextInputs)();
};

const onEscKeydown = (evt) => {
  if ((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.isEscEvent)(evt) && (0,_validation_js__WEBPACK_IMPORTED_MODULE_1__.hashtagCommentIsFocused)()) {
    evt.preventDefault();
    onFormClose();
  }
};
...
const createSlider = () => {
  nouislider__WEBPACK_IMPORTED_MODULE_4__["default"].create(sliderElement, {
    range: {
      min: 0,
      max: 1,
    },
...
const setUserFormSubmit = (onTrue) => {
  formSubmit.addEventListener('submit', (evt) => {
    ...
    (0,_api_js__WEBPACK_IMPORTED_MODULE_3__.sendData)(
      () => {
        onTrue();
        (0,_alert_messages_js__WEBPACK_IMPORTED_MODULE_2__.formSuccess)();
      },
      () => {
        onFormClose();
        (0,_alert_messages_js__WEBPACK_IMPORTED_MODULE_2__.formError)();
      },
...
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./source/js/util.js");
/* harmony import */ var _render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./render.js */ "./source/js/render.js");
...
const setFilters = (photos) => {
  ...
  (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.renderPictures)(photos);

  const setRandomFilter = () => {
    const pictures = photos.slice();
    (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.renderPictures)((0,_util_js__WEBPACK_IMPORTED_MODULE_0__.getUniqueRandomElements)(pictures, 10));
    defaultFilter.classList.remove('img-filters__button--active');
    discussedFilter.classList.remove('img-filters__button--active');
    randomFilter.classList.add('img-filters__button--active');
  };

  randomFilter.addEventListener('click', lodash__WEBPACK_IMPORTED_MODULE_2___default().debounce(setRandomFilter, 500));

  const setDefaultFilter = () => {
    const pictures = photos.slice();
    (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.renderPictures)(pictures);
    randomFilter.classList.remove('img-filters__button--active');
    defaultFilter.classList.add('img-filters__button--active');
    discussedFilter.classList.remove('img-filters__button--active');
  };

  defaultFilter.addEventListener('click', lodash__WEBPACK_IMPORTED_MODULE_2___default().debounce(setDefaultFilter, 500));
  ...
  const setDiscussedFilter = () => {
    ...
    (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.renderPictures)(pictures.sort(comparePictures));
  ...
  discussedFilter.addEventListener('click',  lodash__WEBPACK_IMPORTED_MODULE_2___default().debounce(setDiscussedFilter, 500));
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   fullSizing: () => (/* binding */ fullSizing)
/* harmony export */ });
/* harmony import */ var _util_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util.js */ "./source/js/util.js");
/* harmony import */ var _comments_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./comments-render.js */ "./source/js/comments-render.js");
...
const fullSizing = (picture) => {
  ...
  document.addEventListener('keydown', onEscKeydown);
  (0,_comments_render_js__WEBPACK_IMPORTED_MODULE_1__.renderComments)(picture);
  (0,_comments_render_js__WEBPACK_IMPORTED_MODULE_1__.getComments)(picture);
...
/* harmony export */ });
/* harmony import */ var _full_sizing_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./full-sizing.js */ "./source/js/full-sizing.js");
...
const createPicture = (picture) => {
  ...
  newPicture.addEventListener('click', function (evt) {
    evt.preventDefault();
    (0,_full_sizing_js__WEBPACK_IMPORTED_MODULE_0__.fullSizing)(picture);
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   compareStringLength: () => (/* binding */ compareStringLength),
/* harmony export */   getRandomArrayElement: () => (/* binding */ getRandomArrayElement),
/* harmony export */   getRandomNumber: () => (/* binding */ getRandomNumber),
/* harmony export */   getUniqueRandomElements: () => (/* binding */ getUniqueRandomElements),
/* harmony export */   isEnterEvent: () => (/* binding */ isEnterEvent),
...
/* harmony export */   hashtagCommentIsFocused: () => (/* binding */ hashtagCommentIsFocused),
...
/*!***************************!*\
  ...
  \***************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _editing_from_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./editing-from.js */ "./source/js/editing-from.js");
/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./api.js */ "./source/js/api.js");
/* harmony import */ var _alert_messages_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./alert-messages.js */ "./source/js/alert-messages.js");
...
(0,_api_js__WEBPACK_IMPORTED_MODULE_1__.getData)(
  (photos) => (0,_filter_js__WEBPACK_IMPORTED_MODULE_3__.setFilters)(photos),
  () => (0,_alert_messages_js__WEBPACK_IMPORTED_MODULE_2__.renderError)(),
);

(0,_editing_from_js__WEBPACK_IMPORTED_MODULE_0__.openEditingForm)();
